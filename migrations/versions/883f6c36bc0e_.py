...
Revision ID: 883f6c36bc0e
Revises: 
Create Date: 2022-11-02 19:45:08.720526
...
def upgrade():
    ...
    sa.Column('stage', sa.Enum('inscripcion_abierta', 'inscripcion_cerrada', 'competicion_finalizada', name='stages'), nullable=False),
