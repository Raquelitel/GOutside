...
Revision ID: a785bce3090c
Revises: 
Create Date: 2022-10-07 19:14:49.922354
...
def upgrade():
    ...
    sa.Column('category', sa.Enum('rx_femenino', 'rx_masculino', 'scalled_femenino', 'scalled_masculino', 'elite_femenino', 'elite_masculino', 'equipos', name='category'), nullable=False),
